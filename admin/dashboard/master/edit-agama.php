                                        ...
                                        <?php
                                            ...
                                            if (isset($_POST['simpan'])) {
                                                ...
                                                if(!isset($error)){
                                                    ...
                                                    $sql = 'UPDATE agama SET id_agama=:id_agama, nama_agama=:nama_agama, tgl_update=:tgl_update, user_update=:user_update WHERE id_agama=:id_agama';
                                                    ...
                                                    $stmt->execute();
                                                    echo "<script>document.location.href='http://localhost/terput2/admin/dashboard/master/form-agama.php';</script>";
                                                }
                                            }

                                            // Gunakan prepared statement untuk mencegah SQL injection
                                            $id_agama = $_GET['id_agama'];
                                            $stmt = $conn->prepare("SELECT * FROM agama WHERE id_agama = :id_agama");
                                            $stmt->bindParam(':id_agama', $id_agama);
                                            $stmt->execute();
                                        ...
                                        ?>
                                            <form action="" method="POST">
                                                ...
                                                <div class="form-floating mb-3 ">
                                                        <input disabled type="text" class="form-control" id="id_jenjang"  value="<?= $edit['id_agama'] ?>">
                                                        <label class="mx-2" for="id_jenjang">Id Agama</label>
                                                    </div>
                                                    <div class="form-floating mb-3">
