...
?>
    <script>
        ...
        window.open('http://localhost/terput2/admin/login.php', '_self');
    </script>
<?php
} else {
            ...
            <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" href="http://localhost/terput2/admin/dashboard/settings.php">Settings</a></li>
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="http://localhost/terput2/admin/dashboard/">
